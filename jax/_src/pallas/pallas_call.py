...
def _pallas_call_lowering(
  ...
  def tpu_lowering(
    ...
    if compiler_params is not None:
      lowering_rule = pallas_core.get_lowering_rule(type(compiler_params))
      if lowering_rule is not None:
        return lowering_rule(ctx, *in_nodes, **params)
  ...
  def gpu_lowering(
    ...
    if compiler_params is not None:
      lowering_rule = pallas_core.get_lowering_rule(type(compiler_params))
      if lowering_rule is not None:
        return lowering_rule(ctx, *in_nodes, compiler_params=compiler_params, **params)
